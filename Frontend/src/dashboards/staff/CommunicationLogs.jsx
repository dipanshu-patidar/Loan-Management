...
const CommunicationLogs = () => {
  ...
  const chats = [
    { 
      ...
      role: 'Global Admin', 
      roleKey: 'Admin',
      lastMessage: 'Please review the new loan application APP-001.', 
      time: '10:45 AM', 
      unread: 2, 
      status: 'online',
      avatar: 'AD'
    ...
    { 
      ...
      roleKey: 'Borrower',
      lastMessage: 'I have uploaded my bank statement.', 
      time: '09:30 AM', 
      unread: 0, 
      status: 'offline',
      avatar: 'AJ'
    ...
    { 
      ...
      role: 'Staff Group', 
      roleKey: 'Staff',
      lastMessage: 'Verification for PAY-881 is complete.', 
      time: 'Yesterday', 
      unread: 0, 
      status: 'online',
      avatar: 'IO'
    ...
    { 
      id: 4, 
      name: 'Agent Sarah Jones', 
      role: 'Field Agent', 
      roleKey: 'Agent',
      lastMessage: 'Field visit scheduled for LN-2938.', 
      time: 'Yesterday', 
      unread: 1, 
      status: 'online',
      avatar: 'SJ'
  ...
  const messages = [
    { id: 1, text: 'Hello Alice, I am reviewing your application APP-001.', sender: 'me', time: '10:00 AM', status: 'read' },
    { id: 2, text: 'I noticed your bank statement is missing page 4.', sender: 'me', time: '10:02 AM', status: 'read' },
    { id: 3, text: 'Understood. I will re-upload the complete document now.', sender: 'other', time: '10:15 AM', status: 'received' },
  ];
            ...
            >
              <div className="relative">
                <div className={cn(
                  ...
                  chat.roleKey === 'Agent' ? "bg-amber-50 text-amber-600" :
        ...
        {selectedChat ? (
          <>
            ...
            <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-white/50 backdrop-blur-md sticky top-0 z-10">
              <div className="flex items-center gap-4">
                <div className={cn(
                  ...
                  selectedChat.roleKey === 'Agent' ? "bg-amber-50 text-amber-600" :
                  "bg-emerald-50 text-emerald-600"
                )}>
                  {selectedChat.avatar}
                </div>
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => setIsSnapshotDrawerOpen(true)} className="p-2.5 text-slate-400 hover:text-primary hover:bg-slate-50 rounded-xl transition-all" title="View Detail Snapshot"><Eye size={18} /></button>
            ...
            <div className="p-8 border-t border-slate-50 bg-white shrink-0 space-y-6">
              <div className="flex gap-2 p-1 overflow-x-auto no-scrollbar">
                <QuickTemplate label="Document Request" onClick={() => setMessage("SYSTEM NOTICE: Please upload your latest bank statement for review.")} />
                <QuickTemplate label="Verification Done" onClick={() => setMessage("SUCCESS: Your payment verification is complete.")} />
                <QuickTemplate label="EMI Reminder" onClick={() => setMessage("REMINDER: Your EMI payment is due within 48 hours.")} />
                <QuickTemplate label="Staff Update" onClick={() => setMessage("OPERATIONAL: Application status updated for internal review.")} />
              </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-12 text-center space-y-6">
            ...
            <div className="max-w-xs space-y-3">
              ...
              <p className="text-sm font-medium text-slate-500 leading-relaxed">Collaborate with the team and assist borrowers. Select a thread to start the operational workflow.</p>
            </div>
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="space-y-3">
                        ...
                        <select className="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 text-sm font-bold text-slate-600 outline-none focus:ring-2 focus:ring-primary/10 shadow-inner">
                           ...
                           <option>Alice Johnson (Verified Borrower)</option>
                           <option>Agent Sarah Jones</option>
                     ...
                     <div className="space-y-3">
                        ...
                        <textarea placeholder="Type your instruction or borrower update..." className="w-full bg-slate-50 border-none rounded-2xl p-5 text-sm font-medium text-slate-700 min-h-[120px] focus:ring-2 focus:ring-primary/10 outline-none shadow-inner" />
                     </div>
                  </div>
               ...
               <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }} transition={{ type: 'spring', damping: 25, stiffness: 200 }} className="fixed top-0 right-0 h-screen w-full max-w-sm bg-white shadow-2xl z-[101] flex flex-col">
                  ...
                  <div className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar">
                     ...
                     <div className="space-y-6">
                        ...
                        <TimelineItem icon={Mail} title="Payment Reminder Sent" date="10 mins ago" type="System" />
                        <TimelineItem icon={ShieldCheck} title="Document Verified" date="2 hours ago" type="Staff" />
                        <TimelineItem icon={Clock} title="Awaiting Response" date="Active" type="Operational" color="amber" />
                     </div>
                  </div>
               </motion.div>
            </>
...
const TimelineItem = ({ icon: Icon, title, date, type, color = "navy" }) => (
  <div className="flex gap-5 relative group">
    <div className={cn(
      "w-6 h-6 rounded-lg flex items-center justify-center relative z-10 shadow-sm",
    ...
    <div className="flex-1 min-w-0">
      ...
      <div className="mt-2 inline-flex items-center gap-1.5 px-2 py-0.5 bg-slate-50 rounded text-[8px] font-black text-slate-500 uppercase tracking-widest">
