...
import { X, Mail, Lock, Phone, User, ArrowRight, ShieldCheck, CheckCircle2 } from 'lucide-react';
...
export const AuthModal = ({ isOpen, onClose, initialTab = 'login', loanData }) => {
  ...
  // Form States
  const [loginData, setLoginData] = useState({ email: 'borrower@lms.com', password: 'borrower123' });
  ...
  const handleSuccess = () => {
    setIsLoading(true);
    setTimeout(() => {
      // Redirect to apply-loan with state
                ...
                {activeTab === 'login' ? (
                  ...
                  >
                    <div className="mb-8">
                      ...
                      <p className="text-slate-500 text-sm">Please enter your credentials to continue your application.</p>
                    </div>

                    <form onSubmit={handleLogin} className="space-y-5">
                      <Input
                        label="Email / Phone"
                        placeholder="borrower@lms.com"
