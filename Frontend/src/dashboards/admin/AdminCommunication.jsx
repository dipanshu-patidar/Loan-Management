...
const AdminCommunication = () => {
  ...
  const chats = [
    { 
      ...
      role: 'Field Agent', 
      roleKey: 'Agent',
      lastMessage: 'The collection report for Sector 4 is ready.', 
      time: '10:30 AM', 
      unread: 1, 
      status: 'online',
      avatar: 'SJ'
    ...
    { 
      ...
      role: 'Branch Staff', 
      roleKey: 'Staff',
      lastMessage: 'Verification pending for 3 new applications.', 
      time: '09:15 AM', 
      unread: 0, 
      status: 'away',
      avatar: 'MN'
    ...
    { 
      id: 3, 
      name: 'Borrower - David Gumede', 
      role: 'Verified Borrower', 
      roleKey: 'Borrower',
      lastMessage: 'Escalation regarding my loan approval delay.', 
      time: 'Yesterday', 
      unread: 3, 
      status: 'online',
      avatar: 'DG'
    ...
    { 
      ...
      role: 'Technical Team', 
      roleKey: 'Staff',
      lastMessage: 'Server maintenance scheduled for 11 PM.', 
      time: 'Yesterday', 
      unread: 0, 
      status: 'offline',
      avatar: 'SS'
  ...
  const messages = [
    { id: 1, text: 'Hello David, I am reviewing your escalation request.', sender: 'me', time: '10:00 AM', status: 'read' },
    { id: 2, text: 'Please ensure all FICA documents are updated in the system.', sender: 'me', time: '10:02 AM', status: 'read' },
    { id: 3, text: 'Thank you Admin. I have uploaded the latest utility bill.', sender: 'other', time: '10:15 AM', status: 'received' },
  ];
          ...
          <>
            ...
            <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-white/50 backdrop-blur-md sticky top-0 z-10">
              ...
              <div className="flex items-center gap-2">
                <button className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all shadow-sm">
            ...
            <div className="p-8 border-t border-slate-50 bg-white shrink-0 space-y-6">
              <div className="flex gap-2 p-1 overflow-x-auto no-scrollbar">
                <QuickTemplate label="Operational Update" onClick={() => setMessage("SYSTEM UPDATE: Please be advised that...")} />
                <QuickTemplate label="Collection Reminder" onClick={() => setMessage("REMINDER: Outstanding collection reports are due today.")} />
                <QuickTemplate label="Approval Escalation" onClick={() => setMessage("I have reviewed your escalation regarding...")} />
                <QuickTemplate label="Compliance Notice" onClick={() => setMessage("Notice: Please update your compliance documents.")} />
              </div>
            ...
            <Modal isOpen onClose={() => setIsNewChatModalOpen(false)} title="New Administrative Broadcast" maxWidth="max-w-xl">
               <div className="space-y-8">
                  <div className="space-y-6">
                     ...
                     <div className="space-y-3">
                        ...
                        <select className="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 text-sm font-bold text-slate-600 outline-none focus:ring-2 focus:ring-primary/10 shadow-inner">
                           <option>Broadcast to All Selected Group</option>
                           <option>Agent: Sarah Jones</option>
                           <option>Staff: Michael Nkosi</option>
                           <option>Borrower: David Gumede</option>
                        </select>
                     </div>
                     <div className="space-y-3">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Instruction / Message</p>
                        <textarea placeholder="Type administrative broadcast or private message..." className="w-full bg-slate-50 border-none rounded-2xl p-5 text-sm font-medium text-slate-700 min-h-[120px] focus:ring-2 focus:ring-primary/10 outline-none shadow-inner" />
                     </div>
                  </div>
                  <div className="flex gap-4 pt-4 border-t border-slate-50">
                     ...
                     <Button onClick={() => setIsNewChatModalOpen(false)} className="flex-1 font-black uppercase text-[10px] shadow-lg shadow-primary/20">Execute Broadcast</Button>
                  </div>
               </div>
            </Modal>
         )}
               ...
               <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }} transition={{ type: 'spring', damping: 25, stiffness: 200 }} className="fixed top-0 right-0 h-screen w-full max-w-sm bg-white shadow-2xl z-[101] flex flex-col">
                  ...
                  <div className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar">
                     ...
                     <div className="space-y-6">
                        ...
                        <SummaryRow label="Last Activity" value="10 mins ago" />
                        <SummaryRow label="Security Status" value="Verified" color="text-emerald-500" />
                        <SummaryRow label="Total Inquiries" value="12" />
                        <SummaryRow label="Account Health" value="Premium" color="text-primary" />
                     </div>
                  </div>
               </motion.div>
            </>
